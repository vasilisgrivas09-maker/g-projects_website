...
/** Architectural woodwork — ceilings, cladding, partitions, media walls */
export const eidikesProjects: GalleryProject[] = [
  {
    id: "ergo-001",
  ...
  },
  {
   ...
   title: "Ξύλινη Σκάλα",
   category: "Ειδικές κατασκευές",
   cover: "/gallery/ergo-033-05.webp",
   images: [
     { src: "/gallery/ergo-033-05.webp", alt: "Ξύλινη Σκάλα — 1" },
    ],
  },
];
