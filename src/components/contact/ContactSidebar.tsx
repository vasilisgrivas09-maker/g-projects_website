...
export default function ContactSidebar() {
  return (
    <div className="lg:col-span-4 p-8 lg:p-10 flex flex-col justify-between gap-8 bg-[#f4f1ea] text-left">
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-3">
          <span className="w-8 h-8 text-[#b79a69] shrink-0" aria-hidden>
            <svg
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
      ...
      <div className="flex flex-col gap-4 border-t border-gray-300 pt-6">
        ...
        <div className="flex flex-col gap-3">
          <a
            href={`tel:${PHONE}`}
            className="flex items-center gap-3 hover:text-[#b79a69] transition-colors py-1 group min-h-11 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#b79a69] focus-visible:ring-offset-2 rounded-md"
          >
            <span
      ...
      <div className="flex gap-3 mt-auto">
        <a
          ...
          rel="noopener noreferrer"
          aria-label="Facebook"
          className="w-11 h-11 rounded-full bg-[#1877f2] flex items-center justify-center text-white hover:scale-110 transition-transform shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#b79a69] focus-visible:ring-offset-2"
        >
        ...
        <a
          ...
          className="w-11 h-11 rounded-full bg-black flex items-center justify-center text-white hover:scale-110 transition-transform shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#b79a69] focus-visible:ring-offset-2"
        >
          <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" aria-hidden>
